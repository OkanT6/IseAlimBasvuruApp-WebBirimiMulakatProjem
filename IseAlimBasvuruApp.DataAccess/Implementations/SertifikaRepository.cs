...
{
    internal class SertifikaRepository:GenericRepository<Sertifika>, ISertifikaRepository
    {
        private readonly IseAlimBasvuruAppDbContext _context;

        public SertifikaRepository(IseAlimBasvuruAppDbContext context) : base(context)
        {
            {
                _context = context;
            }
