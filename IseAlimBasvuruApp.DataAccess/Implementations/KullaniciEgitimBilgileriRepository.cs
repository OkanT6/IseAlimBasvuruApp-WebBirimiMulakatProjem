...
{
    internal class KullaniciEgitimBilgileriRepository:GenericRepository<KullaniciEgitimBilgileri>, IKullaniciEgitimBilgileriRepository
    {
        private readonly IseAlimBasvuruAppDbContext _context;

        public KullaniciEgitimBilgileriRepository(IseAlimBasvuruAppDbContext context) : base(context)
        {
            {
                _context = context;
            }
