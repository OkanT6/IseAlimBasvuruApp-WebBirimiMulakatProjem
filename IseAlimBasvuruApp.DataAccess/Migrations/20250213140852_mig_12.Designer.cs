...
namespace IseAlimBasvuruApp.DataAccess.Migrations
{
    ...
    [Migration("20250213140852_mig_12")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IseAlimBasvuruApp.Domain.Entities.Ilan", b =>
                {
                    ...
                    b.Property<string>("IlanIsTanimiUzun")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime>("IlanKapatilmaTarihi")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("IlanYayinlanmaTarihi")
                        .HasColumnType("datetime2");

                    b.Property<int>("IsYeriLokasyonId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IseAlimBasvuruApp.Domain.Entities.IsYeriLokasyon", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IseAlimBasvuruApp.Domain.Entities.Ilan", b =>
                {
                    b.HasOne("IseAlimBasvuruApp.Domain.Entities.IsYeriLokasyon", "IsYeriLokasyon")
                        .WithOne("Ilan")
                        .HasForeignKey("IseAlimBasvuruApp.Domain.Entities.Ilan", "IsYeriLokasyonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
